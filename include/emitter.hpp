...
class CompilerVisitor : public Visitor
{
    ...
    public:
        ...
        {
            if (variable_map.find(node->ident()->ident()) == variable_map.end() || variable_map[node->ident()->ident()] > scope)
            {
                out << "double ";
        ...
        {
            if (variable_map.find(node->identifer()->ident()) == variable_map.end() || variable_map[node->identifer()->ident()] > scope)
            {
                out << "double ";
